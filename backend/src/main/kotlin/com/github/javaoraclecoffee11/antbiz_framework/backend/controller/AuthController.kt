...
import com.github.javaoraclecoffee11.antbiz_framework.backend.exceptions.AlreadyExistException
...
import com.github.javaoraclecoffee11.antbiz_framework.backend.lib.ApiResponseDTO
import com.github.javaoraclecoffee11.antbiz_framework.backend.lib.datetimeParser
import com.github.javaoraclecoffee11.antbiz_framework.backend.model.GenderEnum
...
import com.github.javaoraclecoffee11.antbiz_framework.backend.repository.RefreshTokenRepository
import com.github.javaoraclecoffee11.antbiz_framework.backend.repository.UserRepository
import com.github.javaoraclecoffee11.antbiz_framework.backend.service.TokenService
...
class AuthController(
   ...
   @PostMapping("/login")
   @Operation(
       summary = "Authenticate user and generate JWT tokens", description =
           """
   ...
   fun authenticateUser(
    ...
    @PostMapping("/refresh")
    @Operation(
        summary = "Refresh JWT tokens", description = """
    ...
    fun getUserInfo(
        ...
        userDTO.profileEndpoint = ""
        userDTO.profileBucketName = ""
    ...
    @Operation(
        ...
        description = """
            Updates the user's profile image. The image will be uploaded to storage.
